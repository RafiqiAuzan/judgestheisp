              ...
              <div class="lg:flex items-center">
                  ...
                  <div class="grid grid-cols-1 rounded-xl bg-[#F6F6F6]/60 px-2 py-2 lg:py-6">
                      <div class="flex mt-2 lg:mt-0 pb-5">
                          ...
                          Total data mencapai <strong>132.785</strong></p>
                      </div>
                      <div class="flex mt-2 lg:mt-0 pb-5">
                          <img class="w-4 h-4 my-1"
                          src="{{ URL::to('/img/providers/dot.png') }}">
              ...
              <div class="px-10 pb-8 mx-auto text-center mb-[60px]">
                  ...
                  <div class="grid gap-5 grid-cols-2 pt-5 lg:grid-cols-3 px-10 lg:px-32">
                      <div class="rounded-xl shadow-xl py-3 bg-[#F5BEBE]/40">
                          ...
                          <p class="font-display text-3xl font-bold">37.719</p>
                      ...
                      <div class="rounded-xl shadow-xl py-3 bg-[#EDEDED]/40">
                          ...
                          <p class="font-display text-3xl font-bold">58.144</p>
                      ...
                      <div class="rounded-xl shadow-xl py-3 bg-[#BEF5C2]/40">
                          ...
                          <p class="font-display text-3xl font-bold">23.954</p>
          ...
          <div class="container swiper mySwiper">
              <div class="p-5 swiper-wrapper">
                  <div class="swiper-slide">
                      ...
                      <p class="text-center font-display mt-1 font-semibold ">@yuni_marimar</p>
                      </div>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      ...
                      <p class="text-center font-display mt-1 font-semibold ">@PradythaVelisya</p>
                      </div>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      ...
                      <p class="text-center font-display mt-1 font-semibold ">@elfanmdi</p>
                      </div>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      ...
                      <p class="text-center font-display mt-1 font-semibold ">@blithenesc</p>
                      </div>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      ...
                      <p class="text-center font-display mt-1 font-semibold ">@areuokayhun</p>
                      </div>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      ...
                      <p class="text-center font-display mt-1 font-semibold ">@lpuwormn</p>
                      </div>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      ...
                      <p class="text-center font-display mt-1 font-semibold ">@SinggangMs</p>
                      </div>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      ...
                      <p class="text-center font-display mt-1 font-semibold ">@slaythv</p>
                      </div>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      ...
                      <p class="text-center font-display mt-1 font-semibold ">@Bramjungs</p>
                      </div>
                      </div>
                  </div>
                  <div class="swiper-slide">
                      ...
                      <p class="text-center font-display mt-1 font-semibold ">@jonquiIe</p>
                      </div>
                      </div>
                  </div>
              </div>
      ...
      <div class="bg-[#EDEDED]">
          <div class="container mx-auto flex items-center space-between pt-10">
              <div class="px-10 pb-8 mx-auto text-center lg:mb-[30px]">
                  <div class="mt-10">
                      <h1 class="font-display pb-5 text-3xl font-extrabold text-base-800">Hasil Akurasi Indihome</h1>
                  </div>
          ...
          <div class="lg:flex items-center pb-10">
              ...
              <div class="item-center px-3 lg:grow lg:px-10 lg:ml-[95px] ">
                  ...
                  <p
                      ...
                      kelas sentimen negatif sebanyak <strong>37.719 data</strong>, 
                      kelas sentimen netral sebanyak <strong>58.144 data</strong>, 
                      dan kelas sentimen positif sebanyak <strong>23.954 data</strong>.
                  </p>
                  </div>
          </div>
      </div>
